<template>
    <div id="cover">
        <!-- <img :src="rumagadang" alt="rumagadang" width="170" class="absolute inset-0 m-auto opacity-30 z-10" id="rumagadang"> -->
        ...
        <div class="relative h-screen w-full bg-blue-darkest ">
            <div class="z-20 relative h-screen flex flex-col justify-between items-center text-base">
                ...
                <div class="flex flex-col items-center mb-52" id="guest">
