<template>
    <img :src="flowerOneSide" alt="flower-left-top" class="fixed-elements fixed -left-7 -top-5 opacity-30 z-10" width="190" id="flower-left-top" fetchpriority="high">
    <img :src="flowerOneSide" alt="flower-right-top" class="fixed-elements fixed -right-7 -top-5 opacity-30 flip-verticaly z-10" width="190" id="flower-right-top" fetchpriority="high">
    <img :src="flowerOneSide" alt="flower-left-bottom" class="fixed-elements fixed -left-7 -bottom-5 opacity-30 flip-and-rotate z-10" width="190" id="flower-left-bottom" fetchpriority="high">
    <img :src="flowerOneSide" alt="flower-right-bottom" class="fixed-elements fixed -right-7 -bottom-5 opacity-30 rotate-180 z-10" width="190" id="flower-right-bottom" fetchpriority="high">
    ...
    <img :src="graphicPlain" alt="graphic-plain" class="fixed-elements fixed inset-0 m-auto flex justify-center items-center w-full md:w-1/3 lg:w-1/4 px-1 opacity-0 z-10" id="graphic-plain">
        ...
        <section class="page s3 h-screen flex flex-col justify-center items-center z-20">
            <div class="h-dvh flex flex-col justify-center items-center relative" id="couple">
                ...
                <div class="flex flex-col h-auto items-center mt-4 relative">
                    <!-- Bride Info -->
                    <div class="flex flex-col items-center mb-4 lg:mb-10 static -ml-40 opacity-0 z-20" id="bride-info">

                        <div class="relative">
                            <span class="name text-2xl text-red-darkest font-semibold z-10">Ainun Rahmania S.T</span>
                    ...
                    <!-- Groom Info -->
                    <div class="flex flex-col items-center mt-5 lg:mt-12 -mr-40 opacity-0 z-20" id="groom-info">

                        <div class="relative">
                            <span class="name text-2xl text-red-darkest font-semibold z-10">Arief Trifianto Nurichsan S.T</span>
                ...
                <div class="inset-0 flex flex-col justify-center items-center z-20">
                    ...
                    <div class="flex flex-col justify-center items-center static mt-20 opacity-0" id="event-akad">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="font-semibold text-brown text-base ml-2">08:00 WIB</span>
                        </div>
                    </div>
                    <!-- Akad Location -->
        ...
        <section class="page s5 h-screen flex flex-col justify-center items-center relative w-full z-20">
            <div class="h-dvh flex flex-col justify-center items-center relative w-full" id="resepsi">
                <div class="flex flex-col absolute top-8 lg:top-12 justify-center items-center">
                    ...
                    <div class="grid grid-cols-4 gap-3 lg:gap-4 my-6 text-red opacity-0" id="timespan">
                ...
                <div class="absolute inset-0 flex flex-col justify-center items-center -mt-12 z-20 fixed top-0 left-0 right-0 ">
                    ...
                    <div class="flex flex-col justify-center items-center static mt-20 opacity-0" id="event-resepsi">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="font-semibold text-brown text-base ml-2">11:00 - 13:00 WIB</span>
                        </div>
                    </div>
                    <!-- Resepsi Location -->
    ...
    data() {
        return {
            ...
            gallery: [
                ...
                { id: '3', url: new URL('./assets/photo/gallery/3.jpg', import.meta.url).href },
                { id: '4', url: new URL('./assets/photo/gallery/4.jpg', import.meta.url).href },
                { id: '5', url: new URL('./assets/photo/gallery/5.jpg', import.meta.url).href },
                { id: '6', url: new URL('./assets/photo/gallery/6.jpg', import.meta.url).href },
                { id: '7', url: new URL('./assets/photo/gallery/7.jpg', import.meta.url).href },
                { id: '8', url: new URL('./assets/photo/gallery/8.jpg', import.meta.url).href },
                { id: '9', url: new URL('./assets/photo/gallery/9.jpg', import.meta.url).href },
