<template>
    ...
    <div class="relative overflow-x-hidden flex flex-col items-center">
        ...
        <!-- Ar-Rum -->
        <div class="section h-dvh flex flex-col justify-center items-center px-12 lg:w-1/2 w-full z-20" id="ar-rum">
        ...
        <!-- Salam -->
        <div class="section h-dvh flex flex-col justify-center items-center px-12 w-full z-20" id="salam">
        ...
        <!-- Couple -->
        <div class="section h-dvh flex flex-col justify-between items-center z-20" id="couple">
...
// import fullpage from "fullpage"
  ...
  export default {
    ...
    mounted(){
        ...
        // this.$refs.fullpage('#list-wishes', {
        //     //options here
        //     scrollOverflow: true
        // });
